...
public class Rabbit2 extends Animal2 implements Herbivore, Hop {
...
//        setAge(3); //like the code above
    ...
    public void printDetails() {
        System.out.println("Rabbit average jump height is " + Hop.getAverageJumpHeight()); //to call static like instance method, must create instance of class/interfact. here we have Hop.
    }
